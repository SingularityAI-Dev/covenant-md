...
domain:
  purpose: >
    Reference COVENANT.md for diff comparisons. Three operations
    (alpha, beta, gamma) with corresponding inputs and outputs.
  depth: shallow
...
Reference fixture for diff-tool unit tests.
